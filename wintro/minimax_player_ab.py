...
class MinimaxPlayer(Player):
	...
	def minimax_search_utility(self, board: GameBoard, plies, alpha, beta) -> float:
		print("the a, b value in this call of minmax utility is: ", alpha, beta, "\n")
		if plies == 0:
			...
			for i in board.get_legal_moves():
				...
				print ("the value is: ", value, "beta is: ", beta, "\n")
				if value >= beta:
					print ("-----yeah! we pruned something!-----\n")
					return value
			...
			for i in board.get_legal_moves():
				...
				print ("the value is: ", value, "alpha is: ", alpha, "\n")
				if value <= alpha:
					print ("-----yeah! we pruned something!-----")
					return value
				beta = min(beta, value)
				print ("now beta is: " , beta , "\n")
			return value
